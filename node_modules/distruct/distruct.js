...
const fn = {
    ...
    "flatten": function(content){
        return content.replace(/(\n|\r)/gi, '').replace(/\ {2,10}/gi, ' ').replace(/\t/, ' ');
    },
    
    "obfuscate": function(js, options){
        var obfuscationResult = JavaScriptObfuscator.obfuscate(js, (options||{ compact: false, controlFlowFlattening: true }));
